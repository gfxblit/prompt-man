...
import { POWER_UP_DURATION, GHOST_SPEED, GHOST_EATEN_SCORE, PACMAN_DEATH_ANIMATION_SPEED, PACMAN_DEATH_ANIMATION_FRAMES, SCARED_GHOST_SPEED_MULTIPLIER } from '../constants/config.js';
