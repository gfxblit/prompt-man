...
import { PACMAN_SPEED, POWER_UP_DURATION, GHOST_EATEN_SCORE, POWER_PELLET_SCORE, ALIGNMENT_TOLERANCE, RESPAWN_INVULNERABILITY_DURATION } from '../constants/config.js';
