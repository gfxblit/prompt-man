...
export const GHOST_OFFSETS = {
  ...
  PINK: [GHOST_PALETTE_OFFSET_X, GHOST_PALETTE_OFFSET_Y + SOURCE_GHOST_SIZE],
  CYAN: [GHOST_PALETTE_OFFSET_X, GHOST_PALETTE_OFFSET_Y + SOURCE_GHOST_SIZE * 2],
  ORANGE: [GHOST_PALETTE_OFFSET_X, GHOST_PALETTE_OFFSET_Y + SOURCE_GHOST_SIZE * 3],
