import { TileType, EntityType } from '../core/types.js';
import type { Entity, IGrid, IGameState, Direction, PointEffect } from '../core/types.js';
import {
  PELLET_SCORE,
  POWER_PELLET_SCORE,
  PACMAN_SPEED,
...
import { PACMAN_ANIMATION_SEQUENCE, GHOST_ANIMATION_SEQUENCE } from '../rendering/sprites.js';
